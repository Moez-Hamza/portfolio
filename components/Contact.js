    ...
    <section>
      ...
      <div className="relative z-10 rounded-md shadow-md  p-4 md:p-10 lg:p-20 max-w-6xl mx-auto mb-20 -mt-4">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="md:ml-4">
            <header className="">
              ...
              <p className="font-light text-base text-black-200 mt-2">
                Fill in the details and I willll get back to you as soon as I can.
              </p>
            </header>
            ...
            <div className="social-icons flex flex-row space-x-8">
              <a
                href='https://www.facebook.com/moez.hamza/'
              ...
              <a
                href='https://www.instagram.com/moez_hamza/'
                className="h-10 w-10 rounded-full hover:bg-blue-500 flex items-center justify-center cursor-pointer"
              >
                <svg
                  width="24"
          ...
          <form className="form rounded-lg bg-gray p-4 flex flex-col da">
            <label htmlFor="name" className="text-sm text-white-600 mx-4">
              {" "}
              Your Name
            </label>
            <input
              ...
              name="name"
            />
            <label htmlFor="email" className="text-sm text-white-600 mx-4 mt-4">
              Email
            </label>
            <input
              type="text"
            ...
            <label
              htmlFor="message"
              className="text-sm text-white-600 mx-4 mt-4"
            >
              Message
            </label>
            <textarea
