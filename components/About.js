...
export default function About({ t, lang, c }) {
  return (
    <section id="a-propos" style={{ background: c.paper_bg, borderTop: `1px solid ${c.bp_line}`, borderBottom: `1px solid ${c.bp_line}`, position: "relative", overflow: "hidden", padding: "5rem 2rem" }}>
      <RuledBg c={c} />
      <div style={{ maxWidth: "900px", margin: "0 auto", position: "relative", zIndex: 1 }}>
        ...
        <div className="two-col" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "3rem" }}>
          <Reveal style={{ borderLeft: `2px solid ${c.red}`, paddingLeft: "1.25rem" }}>
          ...
          <Reveal delay={120}>
            ...
            {EXPERIENCE.map((e, i) => (
              <Reveal key={i} className="soft" delay={160 + i * 90} style={{ marginBottom: "1rem", paddingLeft: "1rem", borderLeft: `1.5px solid ${c.bp_line}`, position: "relative" }}>
